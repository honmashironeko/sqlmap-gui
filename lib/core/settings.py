...
\033[01;33m汉化作者:本间白猫\033[0m        \033[01;33mhttps://y.shironekosan.shop\033[0m
        \033[01;33m关注微信公众号:樱花庄本间白猫\033[0m
...
LEGAL_DISCLAIMER = "使用sqlmap攻击目标而没有事先得到双方的共识是违法的。最终用户有责任遵守所有适用的地方、州和联邦法律。开发者不承担任何责任,也不对该程序的任何滥用或造成的任何损害负责。"
